...
public class CspChangeRequest {
    ...
    public CspChangeRequest(String correlationId, String iccid, String msisdn,
                            String currentCsp, String targetCsp, String requestedBy) {
    ...
    public String toString() {
        return String.format(
                "CspChangeRequest{correlationId='%s', iccid='%s', msisdn='%s', %s→%s, by='%s'}",
                correlationId, iccid, msisdn, currentCsp, targetCsp, requestedBy);
    }
}
